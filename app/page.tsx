...
const TEMPLATES = {
  vacio: {
    ...
    rango_precio: [0, 0], rango_costo: [0, 0], // New Fields for Benchmark
    ...baseFinanciamiento
  },
  ...
  asistente_virtual: { nombre_idea: "Asistencia Virtual Freelance", sector: "Servicios Digitales", moneda: "USD", capital_disponible: 1000, inversion: { insumos: 0, equipos: 800, empaques: 0, permisos: 50, otros: 100 }, precio_venta: 300, costo_directo: 0, gastos_fijos: { marketing: 100, logistica: 0, sueldo_emprendedor: 800, otros: 100 }, ventas: { pesimista: 2, base: 5, optimista: 8, crecimiento_mensual: 5 }, regimen_tributario: "NRUS", inflacion_anual: 2.0, rango_precio: [200, 600], rango_costo: [0, 50], ...baseFinanciamiento },
  ...
  agencia_turismo: { nombre_idea: "Agencia de Viajes y Tours", sector: "Turismo / Ocio", moneda: "USD", capital_disponible: 5000, inversion: { insumos: 0, equipos: 1500, empaques: 0, permisos: 800, otros: 1000 }, precio_venta: 500, costo_directo: 350, gastos_fijos: { marketing: 600, logistica: 100, sueldo_emprendedor: 1200, otros: 500 }, ventas: { pesimista: 5, base: 15, optimista: 40, crecimiento_mensual: 5 }, regimen_tributario: "MYPE", inflacion_anual: 3.0, rango_precio: [100, 1000], rango_costo: [50, 800], ...baseFinanciamiento },
...
export default function Home() {
  ...
  // Helper function to check if a value is within benchmark bounds
